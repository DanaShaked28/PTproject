<?php
    ...
    $User->find_user_by_id($user_id); 
     ...
     if (isset($_POST['submit-service'])){
        ...
        header("Location: Services.php?service=".$Service."&id=".$_SESSION['user_id']);
        exit();
     }
        ...
        <div id="wrapper">
            <div id="internalWrapper">
                ...
                <div id="about">
                    ...
                    <h2> Find a Service </h2> <br>
                    
                    <p>Here you can find the contact details of the professional service providers</p>
                    ...
                    <form method="post" style="padding: 2%;">
                      ...
                      <select id="Service" name="Service">
                         <option></option>
                        <option value="Gas.txt">Gas</option>
                        <option value="Water.txt">Water</option>
                        <option value="Internet.txt">Internet</option>
                        <option value="Cleaning.txt">Cleaning</option>
                      </select>
                      <br><br>
                      <button type="submit-service" value="submit-service" name="submit-service" id="enter">Search</button>
